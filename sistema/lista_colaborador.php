...
<body>
    ...
    <section id="container">
        ...
        <table class="table table-striped">
            ...
            $query = mysqli_query($conection, "SELECT c.idcolaborador, c.nombre, c.dpi, c.colaborador, r.rol FROM colaborador c INNER JOIN rolcolaborador r ON c.rol = r.idrol
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a type="button" class="btn btn-success btn-sm col-xs-2 " href="editar_colaborador.php?id=<?php echo $data["idcolaborador"] ?>" me-md-2>Editar</a>
                            ...
                            ?>
                                ...
                                <a type="button" class="btn btn-danger btn-sm col-xs-2 " href="eliminar_confirmar_colaborador.php?id=<?php echo $data["idcolaborador"] ?>" me-md-2>Eliminar</a>
